...
<div className="grid nav">
    ...
    <div ref={visible_div} style={{backgroundColor:"black", opacity: "0.85", height: "100%", width: "100%", position:"absolute", top: 0, display:"none"}}>
        <div className="grid search_div" style={{height: "10rem"}}>
        <label>
        ...
        <button style={{borderRadius: "1rem", placeSelf:"center", border: "none", color: "white", backgroundColor:"#ff642f"}}onClick={()=> {
            changeState(input.current.value);
        }}><a href={`/recipes/${search_input}`}>Search</a></button>
        <span ref={closer} style={{fontSize: "3rem", color: "white", fontWeight: "bold", borderRadius: "50%", backgroundColor:"red", height:"7.5rem", width: "7.5rem", display:"grid", textAlign:"center", placeContent:"center"}} onClick={()=> {
